...
const Kapil = (props) => {
    ...
    const { animation } = useControls({animation: {value: sillyDancing[0].name, options: {SillyDancing: sillyDancing[0].name, Punching: punching[0].name}}});

    const anims = useMemo(() => [sillyDancing[0], punching[0]], []);
